    ...
    return ( 
        <div className='container'>
            ...
            <div className='row p-5 text-muted' style={{ lineHeight: "1.8", fontSize: "1.2em" }}>
                ...
                <div className='col-6 p-3 text-muted fs-7'>
                    ...
                    <p>Connect on &nbsp;<a href='' style={{ textDecoration: "none" }}>Homepage</a>&nbsp;/ <a href='' style={{ textDecoration: "none" }}>TradingQnA</a>&nbsp; / <a href='' style={{ textDecoration: "none" }}>Twitter</a></p><br />
                </div>
            </div>
        </div>
     );
